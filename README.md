...
![Windows Server 2022 installation in progress](images/writeup1/01-server-os-install.png)
![Setting the local administrator password](images/writeup1/02-admin-password-setup.png)
![VM resource allocation in VirtualBox](images/writeup1/03-vm-settings-ram.png)
...
![Static IP and DNS configuration](images/writeup1/04-static-ip-config.png)
...
![Server Manager before promotion, roles installed](images/writeup1/05-server-manager-pre-promotion.png)
![Starting the AD DS Domain Services Configuration Wizard](images/writeup1/06-dc-promotion-deployment-config.png)
![Configuring database, log and SYSVOL paths during promotion](images/writeup1/07-dc-promotion-paths.png)
![Server Manager after promotion, AD DS and DNS roles active](images/writeup1/08-server-manager-post-promotion.png)
...
![Creating a new Organizational Unit](images/writeup1/09-new-ou-dialog.png)
![Naming collision with the built-in default Users container](images/writeup1/10-ou-naming-clash-error.png)
![Default AD containers view](images/writeup1/11-adcu-default-containers.png)
![Final Corp OU structure: Users, Workstations, Groups, Servers](images/writeup1/12-corp-ou-structure.png)
...
![Final list of test user accounts](images/writeup1/13-final-users-list.png)
![Example user account, General tab](images/writeup1/14-aisha-patel-general-tab.png)
![Example user account, Account tab](images/writeup1/15-aisha-patel-account-tab.png)
![IT-Support security group membership](images/writeup1/20-it-support-members.png)
![Payroll security group membership](images/writeup1/21-payroll-members.png)
...
![Group Policy Management console](images/writeup1/16-gpo-management-console.png)
![Domain Password Policy GPO linked at the domain level](images/writeup1/17-gpo-linked-policies.png)
![Password policy settings: 12-character minimum, complexity enabled](images/writeup1/18-password-policy-settings.png)
![Configured interactive logon banner](images/writeup1/19-login-banner-configured.png)
